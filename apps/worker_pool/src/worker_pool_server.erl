...
%% Specs for the worker supervisor that is started dynamically
-define(SPEC(MFA),
	{worker_sup,
...
init({Limit, MFA, Sup}) ->
    ...
    %% Send message to self, to avoid deadlock caused by starting supervisor child in init function
